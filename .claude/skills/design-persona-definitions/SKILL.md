---
name: design-persona-definitions
description: "Create evidence-based user personas that capture goals, behaviors, frustrations, and context for each stakeholder group. Use when defining who the system is being designed for, aligning teams on user archetypes, or grounding design decisions in real user profiles. Produces persona documents in docs/design/."
argument-hint: "Describe the user group or stakeholder to create a persona for"
---
