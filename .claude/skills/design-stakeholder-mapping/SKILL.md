---
name: design-stakeholder-mapping
description: "Identify all people affected by or involved in a system, map their influence and interest, and prioritize who to design for. Use when starting a new project, entering a new domain, or determining which user groups to research first. Produces stakeholder maps in docs/design/."
argument-hint: "Describe the system, project, or domain to map stakeholders for"
---
...
|----------|-------------------|-----------|----------------------|
| 1 | _group_ | _why first_ | _design-empathy-mapping / design-persona-definitions_ |
| 2 | _group_ | _why next_ | _skill_ |
...
- This is the FIRST skill to run when entering a new domain — it determines who to empathize with
