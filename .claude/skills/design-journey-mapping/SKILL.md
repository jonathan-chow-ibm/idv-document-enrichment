---
name: design-journey-mapping
description: "Map end-to-end user experiences as journey maps. Use when visualizing a user's step-by-step interaction with a system or process, identifying pain points, emotional highs and lows, and opportunity areas. Produces journey map documents in docs/design/."
argument-hint: "Describe the user and the experience or process to map"
---
...
- Flag assumptions that need validation and hand them to `design-assumption-testing`
