---
name: system-causal-loop-mapping
description: "Trace and diagram reinforcing and balancing feedback loops that drive system behavior. Use when investigating why problems persist, why growth stalls, why interventions backfire, or why systems oscillate. Use after stock-and-flow mapping to understand dynamic behavior. Produces causal loop diagrams in docs/design/."
argument-hint: "Describe the behavior or pattern you want to trace feedback loops for"
---
...
- **Delay** — time lag between cause and effect (marked with `||` on diagrams)
...
- **Same direction (+)** — when A increases, B increases (and when A decreases, B decreases)
...
Key questions:
- Which loops are currently dominant? (Explains observed behavior)
