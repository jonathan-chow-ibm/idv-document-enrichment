---
name: design-assumption-testing
description: "Identify riskiest assumptions in a design, define lightweight experiments to validate them, and structure success and failure criteria. Use when a design rests on unvalidated beliefs, before committing to implementation, or when stakeholders disagree on what users need. Produces assumption test plans in docs/design/."
argument-hint: "Describe the design or feature whose assumptions need testing"
---
...
Examine the design artifacts (journey maps, service blueprints, personas, problem frames) and list every assumption they depend on:
