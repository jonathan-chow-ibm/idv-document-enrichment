---
name: design-service-blueprinting
description: "Map frontstage interactions, backstage processes, and support systems to reveal gaps between user experience and operational reality. Use when designing services that involve multiple actors, channels, and behind-the-scenes processes. Produces service blueprint documents in docs/design/."
argument-hint: "Describe the service or process to blueprint"
---
