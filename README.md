...
> - **[Metadata runbook](docs/runbook-metadata.md)** — every extracted field, its source, group, and confidence threshold
...
│   ├── runbook-metadata.md    # every extracted field, source, group, confidence threshold
