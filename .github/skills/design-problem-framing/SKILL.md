---
name: design-problem-framing
description: "Synthesize empathy research into actionable Point-of-View statements and How Might We questions. Use when transitioning from research to ideation, aligning the team on which problem to solve, or reframing a solution-first request into a need-first problem statement. Produces problem frame documents in docs/design/."
argument-hint: "Describe the user need or area to frame as a problem"
---
...
- If evidence is thin, recommend running `design-empathy-mapping` first
...
5. Recommended next step (typically `design-ideation-workshop`)
