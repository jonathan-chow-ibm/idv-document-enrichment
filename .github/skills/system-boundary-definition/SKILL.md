...
description: "Define system boundaries by identifying what is inside and outside the system under study, mapping inputs, outputs, actors, and neighboring systems. Use when starting any systems thinking exercise, scoping an analysis, clarifying what a system is responsible for, or resolving disagreements about system scope. Produces boundary diagrams in docs/design/."
argument-hint: "Describe the system or capability to define boundaries for"
---
