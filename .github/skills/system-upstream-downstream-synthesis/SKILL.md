---
name: system-upstream-downstream-synthesis
description: "Map upstream inputs, downstream dependencies, and cross-boundary ripple effects across interconnected systems. Use when analyzing how changes propagate across organizational and technical boundaries, identifying hidden coupling, or synthesizing knowledge across platforms. Produces dependency maps in docs/design/."
argument-hint: "Describe the system or change whose upstream and downstream effects you want to map"
---
...
- After boundary definition — this skill zooms out to the neighborhood and beyond
...
- What boundary definition exists? (Reference output from `system-boundary-definition`)
...
- What commitments (SLAs, contracts, regulations) constrain how the output can change?
...
| 2 | Downstream A | Further Downstream C | _what changes_ | _time lag_ | _magnitude_ | _lower confidence at each hop_ |
